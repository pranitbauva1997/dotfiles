...
sudo pacman -S --noconfirm python-pipx python-numpy python-scipy python-matplotlib \
    ...
    python-wandb python-celery python-authlib python-gradio python-readability-lxml \
    python-pytesseract
...
yay -S --noconfirm python-transformers python-sentence-transformers python-peft \
    python-bitsandbytes python-trl python-deepspeed python-diffusers \
