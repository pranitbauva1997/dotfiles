...
sudo pacman -S python-numpy python-scipy python-matplotlib python-sympy jupyterlab python-pandas python-pandas-datareader python-numexpr python-bottleneck python-tabulate python-scikit-learn python-numba python-tqdm python-numexpr
